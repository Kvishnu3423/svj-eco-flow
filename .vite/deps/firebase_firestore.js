...
var __PRIVATE_BundleLoader = class {
  ...
  Ha(e) {
    ...
    if (e.Qa.namedQuery)
      ...
      e.Qa.document && (this.Ja[this.Ja.length - 1].document = e.Qa.document, ++t);
  ...
  fc() {
    if (this.path)
      for (let e = 0; e < this.path.length; e++)
        this.wc(this.path.get(e));
  }
  wc(e) {
    if (0 === e.length)
      throw this.Dc("Document fields must not be empty");
    if (__PRIVATE_isWrite(this.dataSource) && on.test(e))
      throw this.Dc('Document fields cannot begin and end with "__"');
  }
};
...
var __PRIVATE_DeleteFieldValueImpl = class ___PRIVATE_DeleteFieldValueImpl extends FieldValue {
  _toFieldTransform(e) {
    if (2 !== e.dataSource)
      throw 1 === e.dataSource ? e.Dc(`${this._methodName}() can only appear at the top level of your update data`) : e.Dc(`${this._methodName}() cannot be used with set() unless you pass {merge:true}`);
...
function __PRIVATE_parseData(e, t) {
  ...
  if (e instanceof FieldValue)
    return function __PRIVATE_parseSentinelFieldValue(e2, t2) {
      if (!__PRIVATE_isWrite(t2.dataSource))
        throw t2.Dc(`${e2._methodName}() can only be used with update() and set()`);
      if (!t2.path)
        throw t2.Dc(`${e2._methodName}() is not currently supported inside arrays`);
  ...
  if (
    ...
    if (t.settings.arrayElement && 4 !== t.dataSource)
      throw t.Dc("Nested arrays are not supported");
  ...
  return function __PRIVATE_parseScalarValue(e2, t2) {
    ...
    if (e2 instanceof DocumentReference) {
      ...
      if (!r.isEqual(n))
        throw t2.Dc(`Document reference is for database ${r.projectId}/${r.database} but should be for database ${n.projectId}/${n.database}`);
      return {
          ...
          fields: {
            ...
            [ut]: {
              arrayValue: {
                values: n.map((e4) => {
                  if ("number" != typeof e4)
                    throw t3.Dc("VectorValues must only contain numeric values.");
